...
<main>
	<section id="hero">
      ...
      <a href="#" class="kv__button">動画でスキルアップ</a>
    </div>
	</section>
	<section id="what">
	...
	<section id="point">
		<img class="tako" src="<?php echo get_template_directory_uri() ?>/images/tako.png" alt="">
		<h2 class="section-title section-title--white">嬉しいポイント</h2>
		<ul>
			<li>ポートフォリオ、どう作るのが正解？</li>
			<li>副業やってみたいけど、スキルが…</li>
			<li>ITとか苦手だけど、少しは知っときたい</li>
